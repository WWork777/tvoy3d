      ...
      for (const file of newFiles) {
        ...
        const response = await fetch(
          "https://content.dropboxapi.com/2/files/upload",
          {
            ...
            headers: {
              Authorization:
                "Bearer sl.B8zqs7NgljzsbNOoruul03FJUA01lEp3-0PNkmp2x0btLZui7HJDkppDn_92otprm4UXGuEzh1Sl1-9v_LOyOlsTOldb1_aXqvYoto1UVRisbagc_B3In8Iz5jbAZ7LqpJ4P-VV-I88J1xE", // замените на ваш токен
        ...
        const responseLink = await fetch(
          "https://api.dropboxapi.com/2/sharing/create_shared_link_with_settings",
          {
            ...
            headers: {
              Authorization:
                "Bearer sl.B8zqs7NgljzsbNOoruul03FJUA01lEp3-0PNkmp2x0btLZui7HJDkppDn_92otprm4UXGuEzh1Sl1-9v_LOyOlsTOldb1_aXqvYoto1UVRisbagc_B3In8Iz5jbAZ7LqpJ4P-VV-I88J1xE",
  ...
  return (
    <>
      <div className="contactform home-form-main">
        ...
        <p>
          Вскоре на указанную вами почту придет ответное предложение с ценой,
          спецификациями и сроками производства
        </p>
