...
import tgIcon from "./telegram-icon.svg";
...
export default function Header() {
  const handleNavLinkClick = () => {
    ...
    const iconCollapse = document.getElementById("navbar-toggler");
  ...
  useEffect(() => {
    const links = document.querySelectorAll(
      "#navbarNavDropdown .nav-close, #navbarNavDropdown .dropdown-item,  .navbar-brand,.nav-link,.d-btn"
    );
    links.forEach((link) => {
        ...
        <div className="container-fluid">
          ...
          >
            ...
            <svg
              ...
              width="55.000000pt"
              height="55.000000pt"
              viewBox="270 0 720.000000 720.000000"
            ...
            >
              <defs>
                ...
                >
                  <stop
                    offset="0%"
                    style={{ stopColor: "rgba(219,17,37,1)" }}
                  />
                  <stop
                    offset="100%"
                    style={{ stopColor: "rgba(133,14,48,1)" }}
                  />
                </linearGradient>
              </defs>
              <g
              ...
              >
                <path
                  d="M6113 7040 c-84 -22 -137 -47 -219 -106 l-61 -43 -49 16 c-69 22
            ...
            >
              Твой <span style={{ fontWeight: 700 }}>3D</span>
            </span>
          </Link>
          <button
            id="navbar-toggler"
          ...
          <div className={`collapse navbar-collapse`} id="navbarNavDropdown">
            <ul className="navbar-nav">
              ...
              <li className="nav-item dropdown">
                ...
                <ul
                  className={`dropdown-menu ${opacity ? `unTransparent` : ""}`}
                >
                  <li>
                    <Link
                      smooth="true"
                      href="/services/3dpechat"
                      onClick={() => window.scrollTo(0, 0)}
                  ...
                  <li>
                    <Link
                      smooth="true"
                      href="/services/rezkaco2"
                      onClick={() => window.scrollTo(0, 0)}
                      className="dropdown-item"
                    >
                      Лазерная резка СО<sub>2</sub>
                    </Link>
                  </li>
                  <li>
                    <Link
                  ...
                  {/* <li><Link smooth="true" href='/vacancy' onClick={() => window.scrollTo(0, 0)} className="dropdown-item">ВАКАНСИИ</Link></li> */}
                </ul>
              </li>
              <li className="nav-item">
                <Link
              ...
              >
                ...
                >
                  ...
                  >
                    <path
                      className="svg-path"
                      d="M4665 4716 c-27 -8 -403 -149 -835 -314 -432 -165 -1413 -539 -2180
-832 -767 -293 -1424 -546 -1459 -563 -69 -33 -140 -96 -166 -146 -25 -50 -30
-121 -11 -179 21 -62 97 -137 176 -174 30 -14 265 -86 522 -159 l467 -134 251
-720 c166 -475 264 -739 286 -777 43 -70 111 -132 184 -167 48 -23 68 -26 155
-26 84 0 109 4 152 24 83 37 122 69 423 346 156 143 286 260 291 260 4 0 189
-146 411 -325 221 -178 425 -339 451 -357 109 -74 272 -93 379 -45 90 39 176
138 213 242 9 25 179 846 378 1825 328 1618 361 1789 361 1875 -1 162 -56 260
-180 321 -78 38 -186 48 -269 25z m143 -298 c7 -7 12 -26 12 -43 0 -52 -720
-3588 -738 -3624 -46 -94 -70 -82 -420 199 -957 769 -1187 957 -1187 967 0 6
349 381 775 834 426 452 783 835 793 850 24 37 24 110 0 152 -20 35 -92 77
-131 77 -26 0 -141 -58 -1660 -834 l-972 -497 -450 128 c-247 70 -450 130
-450 133 0 3 289 115 643 249 353 135 847 323 1097 419 250 95 595 227 765
292 361 138 1823 695 1845 703 27 10 66 7 78 -5z m-1645 -1320 c-200 -210
-1037 -1104 -1047 -1121 -8 -12 -60 -209 -117 -437 -56 -228 -104 -420 -108
-427 -3 -6 -97 250 -209 569 -111 320 -201 582 -200 583 5 4 962 492 1323 675
198 101 364 187 370 191 5 5 14 9 19 9 6 0 -8 -19 -31 -42z m-650 -1607 c92
-74 167 -137 166 -140 -1 -9 -530 -493 -534 -489 -2 2 37 165 86 363 48 198
91 370 94 383 3 13 9 22 13 20 4 -2 83 -63 175 -137z"
                    />
                  </g>
                </svg>
                <p className="hidetxt">@Tvoy3d</p>
              </Link>
              <Link
                smooth="true"
              ...
              >
                ...
                >
                  ...
                  >
                    <path
                      className="svg-path"
                      d="M361 4349 c-172 -34 -318 -182 -351 -358 -14 -74 -14 -2788 0 -2862
                ...
                <p className="hidetxt">Tvoy-3d@yandex.ru</p>
                
              </Link>
              <Link smooth="true" href="tel:+79936307048" className="nav-link">
                <svg
                  className="svg-icon-header"
                  version="1.0"
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="hidetxt">+7 993-630-70-48</p>
              </Link>
              {/* <Link smooth="true" href='/contactform' onClick={() => window.scrollTo(0, 0)} className='nav-link'>КОНТАКТНАЯ ФОРМА</Link> */}
            </div>
          </div>
        </div>
      </nav>
